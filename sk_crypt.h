...
#define skCrypt(str) encrypt_key(str, __TIME__[4], __TIME__[2], __TIME__[8], __TIME__[5])
#define _(str) encrypt_key(str, __TIME__[4], __TIME__[2], __TIME__[8], __TIME__[5]).decrypt()
